...
class Bordertop(Sprite):
    bordertop = RectangleAsset(4000, 100, whiteline, green)
...
class Borderbottom(Sprite):
    borderbottom = RectangleAsset(4000, 100, whiteline, green)
...
class Pong(App):
    def __init__(self):
        ...
        self.bordertop = Bordertop((515, 100))
        
        self.borderbottom = Borderbottom ((515, 400))
